...
def test_getElemXYZ_A(type3D):
    assert type3D.getElemXYZ() == (4,1,2)

def test_coordToNode_A(type3D):
    assert type3D.coordToNode((3,1,2)) == 29

def test_NodeToCoord_A(type3D):
    assert type3D.nodeToCoord(29) == (3,1,2)

def test_getElemOrigin_A(type3D):
    assert type3D.getElemOrigin(7) == (2,0,1)

def test_getElemID_A(type3D):
    assert type3D.getElemID((2,0,1)) == 7

def test_getHex8IDs_A(type3D):
