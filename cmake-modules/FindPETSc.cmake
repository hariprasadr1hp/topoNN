...
if(NOT PETSc_FIND_COMPONENTS)
	...
	list(LENGTH 
		${PETSc_FIND_COMPONENTS} 
		components_length
	)
    if(${components_length} GREATER 1)
		message(FATAL_ERROR 
	  	"Only one component for PETSc is allowed to be specified"
	)
    endif()
    ...
    foreach(component ${PETSc_FIND_COMPONENTS})
		...
		if(${component_location} EQUAL -1)
			message(FATAL_ERROR 
				"\"${component}\" is not a valid PETSc component."
			)
		else()
			list(APPEND 
...
function (petsc_get_version)
	if (EXISTS "${PETSC_DIR}/include/petscversion.h")
		file (STRINGS 
			...
			vstrings 
			REGEX 
			"#define PETSC_VERSION_(RELEASE|MAJOR|MINOR|SUBMINOR|PATCH) "
		)
...
find_package_handle_standard_args (
	PETSc
	REQUIRED_VARS PETSC_INCLUDES 
	PETSC_LIBRARIES 
	PETSC_EXECUTABLE_RUNS
	VERSION_VAR PETSC_VERSION
	FAIL_MESSAGE "PETSc could not be found.  
	Be sure to set PETSC_DIR and PETSC_ARCH."
)
